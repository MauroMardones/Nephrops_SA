...
\paragraph{LPUE Standarized}\label{lpue-standarized}
...
\bottomrule
\endlastfoot
SC0 & Catches; ISUNEPCA UWTV abundance index & 1987–2025 & Baseline configuration using only the UWTV survey as absolute abundance index.\\
SC1 & Catches; ISUNEPCA UWTV abundance; ARSA survey & 1987–2025 & Configuration combining UWTV and ARSA  surveys to assess consistency between fishery-independent indices.\\
SC2 & Catches; ISUNEPCA UWTV abundance; Directed commercial LPUE & 1987–2025 & Configuration including fishery-dependent information through directed LPUE.\\
SC3 & Catches; ISUNEPCA UWTV abundance; Directed fishing effort & 1987–2025 & Configuration using directed fishing effort as a proxy of stock dynamics.\\
SC4 & Catches; ISUNEPCA UWTV abundance; Comercial LPUE & 1987–2025 & Configuration testing the use of standardized LPUE instead of raw commercial indices.\\*
\end{longtable}
\endgroup{}
...
To extend the SPiCT-based assessment of \emph{Nephrops}, we defined \textbf{five additional modelling scenarios (Scenarios 5--9)} that incorporate alternative combinations of fishery-dependent and fishery-independent information. \emph{Scenario 5} combines total landings with the \textbf{normalized ISUNEPCA UWTV biomass index} and the \textbf{normalized ARSA biomass index}, providing a configuration based exclusively on survey-derived biomass information. \emph{Scenario 6} integrates total landings with the \textbf{normalized ISUNEPCA UWTV biomass index} and a \textbf{standardised LPUE}, allowing direct comparison between fishery-independent biomass and fishery-dependent abundance signals. \emph{Scenario 7} represents a more information-rich configuration that combines \textbf{normalized ISUNEPCA biomass}, \textbf{normalized ARSA biomass}, and \textbf{standardised LPUE} together with landings. \emph{Scenario 8} combines landings with the \textbf{normalized ISUNEPCA UWTV abundance index} and \textbf{standardised LPUE}, providing an alternative representation of stock dynamics based on abundance rather than biomass. The definition of \emph{Scenario 9} is motivated by a major structural change in the ARSA survey. In 2012, the ARSA survey programme experienced a change of vessel and operational characteristics, introducing a potential discontinuity in the biomass index methodology estimation. To avoid confounding biological signals with survey artefacts, only the pre-2012 ARSA biomass series is retained in this scenario. Post-2012 stock dynamics are instead informed by the ISUNEPCA UWTV survey, which provides a consistent biomass index from 2015 onward, and by the standardised LPUE, which reflects commercial fleet performance in recent years. This scenario therefore provides a coherent data configuration that respects survey continuity while preserving both long-term and contemporary information for stock assessment (Table \ref{tab:newscenario}). All scenarios include total landings as the catch time series and differ in the configuration of abundance indices (Figure \ref{fig:indices}).
...
\bottomrule
\endlastfoot
SC5 & Catches; ISUNEPCA UWTV biomass (normalized); ARSA biomass (normalized) & 1987–2025 & Scenario combining total landings with normalized ISUNEPCA UWTV biomass and normalized ARSA biomass indices, representing a configuration based exclusively on fishery-independent information.\\
SC6 & Catches; ISUNEPCA UWTV biomass (normalized); Standardised LPUE & 1987–2025 & Scenario integrating total landings with normalized ISUNEPCA UWTV biomass and a standardized LPUE index, combining fishery-independent and fishery-dependent information.\\
SC7 & Catches; ISUNEPCA UWTV biomass (normalized); ARSA biomass (normalized); Standardised LPUE & 1987–2025 & Most information-rich configuration, combining total landings with normalized ISUNEPCA UWTV biomass, normalized ARSA biomass, and standardized LPUE indices to explore model behaviour under maximum data availability.\\
SC8 & Catches; ISUNEPCA UWTV abundance (normalized); Standardised LPUE & 1987-2025 & Scenario integrating total landings with normalized ISUNEPCA UWTV abundance and a standardized LPUE index, combining fishery-independent and fishery-dependent information.\\
SC9 & CATCHES; ISUNEPCA UWTV biomass (normalized), ARSA biomass (normalized), Standardised LPUE & 1987-2025 & Scenario combines total landings with the ISUNEPCA UWTV biomass index (2015–2025), ARSA biomass survey (1993–2012), and the standardised commercial LPUE (2009–2024). This configuration integrates long-term and recent information while ensuring consistency among data sources.\\*
\end{longtable}
\endgroup{}
...
\begin{table}
\centering
\caption{\label{tab:unnamed-chunk-2}Stochastic biological reference points and estimated current catch (Cp) by SPiCT scenario and prior configuration (RUN) for Nephrops FU30.}
\centering
...
SC2 & RUN2 & NA & NA & NA & 31.078\\
\addlinespace
SC2 & RUN3 & NA & NA & NA & 31.078\\
SC2 & RUN4 & 2817.064 & 0.044 & 120.904 & 32.674\\
SC3 & RUN1 & 59940.847 & NA & NA & 0.893\\
SC3 & RUN2 & 69.328 & 6.884 & 1239.830 & 33.734\\
SC3 & RUN3 & NA & NA & 1911.312 & 32.171\\
\addlinespace
