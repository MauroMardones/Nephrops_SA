...
\paragraph{SPiCT model configurations}\label{spict-model-configurations}
...
\begin{longtable}[c]{|p{0.50in}|p{3.00in}|p{2.00in}|p{3.00in}}

\caption{Summary\ of\ SPiCT\ scenarios\ and\ input\ data\ used\ for\ Nephrops\ FU30.}\label{tab:spictscenarios}\\

\ascline{1.5pt}{666666}{1-4}

\multicolumn{1}{>{\raggedright}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{Scenario}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 3in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{Input\ data}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 2in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{Priors}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 3in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{Description\ of\ priors}}}} \\

\ascline{1.5pt}{666666}{1-4}\endfirsthead \caption[]{Summary\ of\ SPiCT\ scenarios\ and\ input\ data\ used\ for\ Nephrops\ FU30.}\label{tab:spictscenarios}\\
...
\multicolumn{1}{>{\raggedright}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{Scenario\ 1}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 3in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{Catches\ (1994–2023);\ ARSA\ spring\ index;\ ARSA\ autumn\ index;\ ISUNEPCA\ UWTV\ biomass\ index;\ ISUNEPCA\ UWTV\ abundance\ index;\ ARSA\ spring\ productivity\ index;\ Commercial\ LPUE}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 2in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{logbkfrac\ <-c(log(0.5),0.2,1)}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 3in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{Baseline\ configuration\ using\ all\ available\ survey\ and\ fishery-dependent\ indices.\ Default\ SPiCT\ priors\ applied\ to\ evaluate\ model\ behaviour\ under\ maximum\ data\ availability.}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{Scenario\ 2}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 3in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{Catches\ (1994–2023);\ ISUNEPCA\ UWTV\ biomass\ index;\ Commercial\ LPUE}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 2in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{Default}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 3in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{Reduced\ configuration\ focusing\ on\ the\ UWTV\ biomass\ index\ combined\ with\ commercial\ LPUE\ to\ assess\ robustness\ under\ limited\ survey\ information.}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{Scenario\ 3}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 3in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{Catches\ (1994–2023);\ ARSA\ spring\ index;\ ISUNEPCA\ UWTV\ biomass\ index\ (ISUNEPBIO2)}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 2in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{Default}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 3in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{Intermediate\ configuration\ combining\ the\ long\ ARSA\ spring\ time\ series\ with\ the\ UWTV\ biomass\ index\ to\ evaluate\ consistency\ between\ fishery-independent\ surveys.}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{Scenario\ 4}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 3in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{Catches\ (1994–2023);\ ISUNEPCA\ UWTV\ biomass\ index}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 2in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{logbkfrac\ <-c(log(0.5),0.2,1)\ ;\ }}}\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{\linebreak }}}\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{\ \ \ \ logn\ <-\ c(log(2),0.5,1);}}}\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{\linebreak }}}\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{\ \ \ \ logr\ <-c(log(0.2),0.2,1)}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 3in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{7}{7}\selectfont{\global\setmainfont{Helvetica}{Minimal\ data\ configuration\ using\ only\ catches\ and\ the\ UWTV\ biomass\ index,\ representing\ a\ conservative\ assessment\ approach\ for\ data-limited\ stocks.}}}} \\
